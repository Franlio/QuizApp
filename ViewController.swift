...
class ViewController: UIViewController, QuizProtocol, UITableViewDelegate, UITableViewDataSource, ResultViewControllerProtocol {
    ...
    @IBOutlet weak var stackViewTrallingConstraint: NSLayoutConstraint!
    ...
    func slideInQuestion() {
        ...
        stackViewTrallingConstraint.constant = -1000
        ...
        UIView.animate(withDuration: 0.3, delay: 0, options: .curveEaseOut, animations: {
            ...
            self.stackViewTrallingConstraint.constant = 0
    ...
    func slideOutQuestion() {
        ...
        // Set the initial state
        stackViewTrallingConstraint.constant = 0
        ...
        UIView.animate(withDuration: 0.3, delay: 0, options: .curveEaseOut, animations: {
            ...
            self.stackViewTrallingConstraint.constant = 1000
    ...
    func displayQuestion() {
        ...
        // Check if there are questions and check that the currentQuestionIndex isn't out of bounds
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        // Make sure that the questions array actually contains at least question
    ...
    func dialogDismissed() {
        ...
        // Increment the currentQusetionIndex
